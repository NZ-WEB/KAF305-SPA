  ...
  <q-container>
    <div v-if="weeksData">
      <div class="flex justify-center">
        ...
        <h5
          align="center"
          class="text-h5 text-primary text-weight-medium q-pt-md"
        >
          Расписание на: {{ weeksData.date }}
        </h5>
      </div>
...
<script>
import AppWeeksSchedule from "components/AppWeeksSchedule.vue";
...
export default {
  ...
  setup() {
    ...
    const weeksData =
      store.getters["schedule/WeekSchedule"][route.params.id - 1];
    ...
    const makeDayName = (date) => {
      ...
      const nameOfDays = ["Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"];
      return nameOfDays[
        new Date(
