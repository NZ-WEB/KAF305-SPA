...
export default {
  ...
  mutations: {
    ...
    setCurrentGroupSchedule(state, currentSchedule) {
      return (state.currentWeekSchedule = currentSchedule);
    },
  },
  actions: {
    async findGroupByName({ commit }, groupName) {
      try {
        const { data } = await axios.get(
          `${process.env.VUE_APP_SCHEDULE_GROUP_BY_NAME_URL}${groupName}`,
          {
            method: "GET",
            headers: {
    ...
    async findTeacher({ commit, getters }, teacherName) {
      try {
        const { data } = await axios.get(
          `${process.env.VUE_APP_FIND_TEACHER_URL}${teacherName}`,
          {
            method: "GET",
            headers: {
              ApiKey: process.env.VUE_APP_SCHEDULE_API_KEY,
    ...
    async loadGroupSchedule({ commit }, id) {
      try {
        const { data } = await axios.get(
          `${process.env.VUE_APP_GROUP_SCHEDULE_URL}${id}`,
          {
            method: "GET",
            headers: {
              ApiKey: process.env.VUE_APP_SCHEDULE_API_KEY,
    ...
    async loadTeacherSchedule({ commit }, id) {
      try {
        ...
        const { data } = await axios.get(
          `${process.env.VUE_APP_TEACHER_SCHEDULE_URL}${id}`,
          {
            method: "GET",
            headers: {
              ApiKey: process.env.VUE_APP_SCHEDULE_API_KEY,
    ...
    async loadCurrentWeek({ commit }, id) {
      try {
        const { data } = await axios.get(
          `${process.env.VUE_APP_CURRENT_WEEK_URL}${id}`,
          {
            method: "GET",
            headers: {
              ApiKey: process.env.VUE_APP_SCHEDULE_API_KEY,
    ...
    async getCurrentGroupSchedule({ commit }, id) {
      try {
        const { data } = await axios.get(
          `${process.env.VUE_APP_CURRENT_WEEK_URL}${id}`,
          {
        ...
        const response = data.data;
        commit("setCurrentGroupSchedule", response);
      } catch (e) {}
    },
  },
